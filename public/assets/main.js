  ...
  $('#button').on('click', function(){
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        $('#results').append('<div id='+title+' class="col-md-3 space"><div class="finalresults"  value='+id+'>'+title+' by: '+author+'<div class="plusbox" id="plusbox"><i class="fa fa-check-circle-o myplus" id="myplus"></i></div></div><div id="thumbwrap" class="thumbwrap" draggable="true" ondragstart="drag(event)"><img id="thumb" class="thumb" alt="img" src='+thumb+' /></div></div>');
        }
      },
    });
  });
